...
describe('ConditionalNode', function() {
  var condition = new ConstantNode(math, true);
  var zero = new ConstantNode(math, 0);
  var one = new ConstantNode(math, 1);
  var two = new ConstantNode(math, 2);
  var three = new ConstantNode(math, 3);
  var a = new AssignmentNode(math, 'a', two);
  var b = new AssignmentNode(math, 'b', three);

  it ('should create a ConditionalNode', function () {
    var n = new ConditionalNode(math, condition, a, b);
  ...
  it ('should throw an error when creating without arguments', function () {
    assert.throws(function () {new ConditionalNode(math)}, TypeError);
    assert.throws(function () {new ConditionalNode(math, condition)}, TypeError);
    assert.throws(function () {new ConditionalNode(math, condition, a)}, TypeError);
    assert.throws(function () {new ConditionalNode(math, condition, null, b)}, TypeError);
  });
  ...
  describe('evaluate', function () {
    var condition = new ConditionalNode(math, new SymbolNode(math, 'a'), one, zero);
  ...
  it ('should run forEach on a ConditionalNode', function () {
    var condition = new ConstantNode(math, 1);
  ...
  it ('should clone a ConditionalNode itself', function () {
    ...
    var a = new ConstantNode(math, 2);
    var b = new ConstantNode(math, 3);
    var c = new ConditionalNode(math, condition, a, b);
