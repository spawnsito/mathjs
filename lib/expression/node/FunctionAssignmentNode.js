 ...
 * Function assignment
 *
 * @param {Object} math           math.js namespace
 * @param {String} name           Function name
 * @param {String[]} params       Function parameter names
 * @param {Node} expr             The function expression
 */
function FunctionAssignmentNode(math, name, params, expr) {
...
FunctionAssignmentNode.prototype.map = function (callback) {
  ...
  return new FunctionAssignmentNode(this.math, this.name, this.params.slice(0), expr);
};
...
FunctionAssignmentNode.prototype.clone = function() {
  return new FunctionAssignmentNode(this.math, this.name, this.params.slice(0), this.expr);
};
