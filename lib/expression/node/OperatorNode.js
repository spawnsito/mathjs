 ...
 */
function OperatorNode (math, op, fn, args) {
...
OperatorNode.prototype.map = function (callback) {
  ...
  return new OperatorNode(this.math, this.op, this.fn, args);
};
...
OperatorNode.prototype.clone = function() {
  return new OperatorNode(this.math, this.op, this.fn, this.args.slice(0));
};
