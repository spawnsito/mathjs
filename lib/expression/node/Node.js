...
Node.prototype.compile = function () {
  if (arguments.length > 0) {
    throw new Error('Passing math via .compile() is deprecated, should be passed via .parse(expr, math)');
  }
  if (!this.math) {
    throw new TypeError('math is undefined');
  }

  // definitions globally available inside the closure of the compiled expressions
  var defs = {
    math: _transform(this.math),
