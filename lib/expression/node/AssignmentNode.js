 ...
 */
function AssignmentNode(math, name, expr) {
...
AssignmentNode.prototype.map = function (callback) {
  return new AssignmentNode(this.math, this.name, this._ifNode(callback(this.expr, 'expr', this)));
};
...
AssignmentNode.prototype.clone = function() {
  return new AssignmentNode(this.math, this.name, this.expr);
};
