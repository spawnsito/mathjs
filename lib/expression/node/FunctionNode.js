 ...
 * @param {Node[]} args
 */
function FunctionNode (math, name, args) {
...
FunctionNode.prototype._compile = function (defs) {
  ...
  if (isRaw) {
    ...
    // "regular" evaluation
    var symbol = new SymbolNode(this.math, this.name);
...
FunctionNode.prototype.map = function (callback) {
  ...
  return new FunctionNode(this.math, this.name, args);
};
...
FunctionNode.prototype.clone = function() {
  return new FunctionNode(this.math, this.name, this.args.slice(0));
};
